...
import fire
from VLIPP.utils.helpers import io_from_json, set_seed
import os

def main(data_root: str, exp_name: str, seed: int = 47):
    """
    ...
    output_folder = os.path.join(data_root, 'noise_flow', exp_name)
    video = os.path.join(data_root, 'animation_video', f'{exp_name}.mp4')
    ...
    output = nw.get_noise_from_video(
        ...
        visualize=False,          #Generates nice visualization videos and previews in Jupyter notebook
